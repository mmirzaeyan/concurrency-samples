		...
		<table class="table table-custom" id="grid" data-component="grid"
			...
			<thead>
				<tr>
					...
					<th class="centered">شماره سفارش 
					</th>
					<th class="centered">شماره تلفن ضروری (تلفن همراه) 
					</th>
					<th class="centered">شماره تلفن  
					</th>
					<th class="centered">وضعیت سفارش  	
					</th>
					<th class="centered">مبلغ سفارش  	
					</th>
			...
			<tbody id="entityBody" class="entityBody">
				<script id="GridRowTemplate" type="text/html">
		                	...
		                	<td class="centered">${mobilePhone}</td>
		                	<td class="centered">${tel}</td>
							<td class="centered">${orderStatusPersianTitle}</td>
							<td class="centered">${price}</td>
							<td class="centered">
								<div class="btn-group btn-group-xs">
										<button type="button" class="btn btn-greensea" role="button" tabindex="0" data-toggle="modal" href="Edit.jsp?id=${id}" data-target="#addModal" onclick="showPublisherProduct()">مشاهده جزییات</button>
								</div>
							</td>
